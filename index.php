                 ...
                 <ul class="nav nav-tabs aa-products-tab">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                        <?php 
                        $query = "SELECT * FROM products where category_id='1' LIMIT 8";
                        ...
                        if ($result->num_rows > 0) {
		                    ...
		                    while ($row = $result->fetch_assoc()) {
                                $output .=  '<li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="admin/images/'.$row["image"]. '" alt="' .$row["name"]. '"></a>
                    ...
                    <div class="tab-pane fade" id="women">
                        <?php 
                        $query = "SELECT * FROM products where category_id='2' LIMIT 8";
                        $result = $conn->query($query);
                        $output = '';
                        if ($result->num_rows > 0) {
                            $output .= '<ul class="aa-product-catg">
		                    ...
		                    while ($row = $result->fetch_assoc()) {
                                $output .=  '<li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="admin/images/'.$row["image"]. '" alt="polo shirt img"></a>
                                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                  <figcaption>
                                    <h4 class="aa-product-title"><a href="#">' .$row["name"]. '</a></h4>
                                    <span class="aa-product-price">' .$row["price"]. '</span>
                    ...
                    <?php 
                        $query = "SELECT * FROM products where category_id='5' LIMIT 8";
                        $result = $conn->query($query);
                        $output = '';
                        if ($result->num_rows > 0) {
                            $output .= '<ul class="aa-product-catg">
                    ...
                    <?php 
                        $query = "SELECT * FROM products where category_id='4' LIMIT 8";
                        $result = $conn->query($query);
                        $output = '';
                        if ($result->num_rows > 0) {
                            $output .= '<ul class="aa-product-catg">
