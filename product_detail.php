...
$query = "SELECT name, description, price FROM products WHERE id = '".$id."' LIMIT 1";
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <?php 
									...
									$query1 = "SELECT quantity FROM stock WHERE id='" .$row["id"]. "'";
                  ...
                  ?></td>
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#"><?php echo $row['image'] ?></a>
                      </p>
                    </div>
